...
The pipeline-wide application of the Anamnesis approach: an owned normalization
...
`normalize`) and the `carmodel` loader are the same design proven in Anamnesis
v1.0.0; the memory artefact reuses Anamnesis's already-finished CAR directly.
