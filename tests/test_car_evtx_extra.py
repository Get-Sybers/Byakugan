...
def test_bits_is_http_get_with_url():
    ev = go_normalize("evtx_bits", _bits())
...
def test_ts_session_userdata_and_local_is_null_ip():
    ev = go_normalize("evtx_rdp", _ts(21, "LOCAL"))
    ...
    assert go_normalize("evtx_rdp", _ts(24))["car_action"] == "logout"
    rdp = go_normalize("evtx_rdp", _ts(21, "10.0.0.9"))
