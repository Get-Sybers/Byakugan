...
picked up automatically — porting a family means ADDING files, never editing
shared ones:

    tests/parity/genf/<family>.py                      (generator, data only)
    tests/parity/fixtures/<family>/                    (generated by it)
    go/internal/predicates/predicates_<family>.go      (the ported gates)
...
`go/DESIGN.md` → "Per-family porting recipe" is the full contract.
"""
