...
# Verbatim copy of byakugan/adapters/l2t_split.py, frozen for the Go parity
# harness (tests/parity): once the Go engine replaces this adapter, the
# live module is deleted and THIS copy remains the executable reference
# the byte-parity tests compare against.
