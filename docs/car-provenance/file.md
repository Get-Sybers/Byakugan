...
Authoritative "find once, done" map of **every canonical field → every artefact/source that can supply it**, grounded in the Byakugan engine as it stands today. READ-ONLY analysis.
