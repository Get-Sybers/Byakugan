...
Authoritative, exhaustive map of **every canonical `registry` field → every artefact/source that can supply it** in the Byakugan CAR pipeline. "Find once, done." Grounded in repo source, honest about gaps and honest nulls. READ-ONLY analysis.
